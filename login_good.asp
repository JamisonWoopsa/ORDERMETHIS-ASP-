...
function openHelp() {
 var newWindow = window.open("help.html", "HELP", "height=300,width=400,scrollbars=yes");
 newWindow.focus();
}
...
<table width="60%" border="0" cellspacing="0" cellpadding="5"  align="center">
   ...
   <TABLE BACKGROUND="img/login.gif" width="358" height="197" border="0" cellspacing="0" cellpadding="0">
    <TR align='left'>
      <TD width="45%">&nbsp</TD>
    </TR>
    <TR align='left'>
    ...
    <TR align="left">
	  <TD COLSPAN=2 align="center"><a href="" STYLE='color : #FFE779' onClick="openHelp(); return false">Click here for help</a></TD>
